...
public class BlockUtil {
	...
	public static float[] getDirectionToBlock(int var0, int var1, int var2, EnumFacing var3) {
		...
		var4.posX = (double) var1 + 0.5D;
		var4.posX = (double) var2 + 0.5D;
		var4.posX += (double) var3.getDirectionVec().getX() * 0.25D;
		var4.posX += (double) var3.getDirectionVec().getY() * 0.25D;
		var4.posX += (double) var3.getDirectionVec().getZ() * 0.25D;
