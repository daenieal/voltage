...
public class MinecraftFontRenderer extends CFont {
    ...
    public int drawStringWithShadow(String text, double x2, double d, int color) {

        float shadowWidth = this.drawString(text, x2 + 0.9f, (double) d + 0.5f, color, true, 8.3f);

        return (int) Math.max(shadowWidth, this.drawString(text, x2, d, color, false, 8.3f));
    }
